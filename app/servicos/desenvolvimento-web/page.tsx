...
export default function DesenvolvimentoWebPage() {
  const features = [
    ...
    },
    {
      ...
      title: "E-commerce",
      description:
        "Lojas virtuais completas e otimizadas para vendas, com experiência de usuário excepcional e altas taxas de conversão.",
    },
    {
  ...
  const faqs = [
    {
      ...
      answer:
        "O tempo de desenvolvimento varia conforme a complexidade do projeto. Um site institucional geralmente leva de 4 a 8 semanas, enquanto um e-commerce pode levar de 8 a 16 semanas. Durante o briefing inicial, forneceremos um cronograma detalhado específico para o seu projeto.",
    },
    {
  ...
  return (
    <>
      <ServiceHero
        title="Desenvolvimento Web Profissional e Orientado a Conversão"
        subtitle="Desenvolvimento Web"
        description="Sites e plataformas digitais que não apenas impressionam visualmente, mas também são estrategicamente projetados para converter visitantes em clientes."
        image="/CARD - WEB SITES.png?height=600&width=600"
        gradient="purple"
      />
